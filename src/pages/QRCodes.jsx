...
export default function QRCodes() {
  ...
  const handleCreate = () => {
    setEditingQR(null);
    setFormData({ venue_id: '', name: '', description: '', mode: 'simple', redirect_url: '' });
    setError('');
    setShowModal(true);
  };
            ...
            <div key={qr.id} className="bg-white p-6 rounded-lg shadow">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-1 flex-wrap justify-end">
                  ...
                  <span className={`px-2 py-1 text-xs rounded ${qr.mode === 'dashboard' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'}`}>
                    {qr.mode === 'dashboard' ? 'Dashboard' : 'Simple'}
                  </span>
                  {qr.redirect_url ? (
                    <span className="px-2 py-1 text-xs rounded bg-green-100 text-green-800">URL Set</span>
                  ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="simple">Simple - Redirect straight to Google Review</option>
                  <option value="dashboard">Dashboard - Internal review + feedback</option>
                </select>
              </div>
